...
type FooterProps = {
    addEmptyField: () => Promise<void>,
    onSaveTeamFields: () => void
}

const FieldsGridFooterComponent: React.FC<FooterProps> = ({ addEmptyField, onSaveTeamFields }) => {
    return (
                ...
                <Box className='fields-and-team-options-container'>
                    ...
                    <Box className='edit-fields-container'>
                        ...
                        <DataGrid
                            ...
                            slotProps={{
                                footer: {
                                    // Dont think MUI liked passing an async function to 
                                    // its props
                                    // @ts-ignore
                                    addEmptyField,   
                                    onSaveTeamFields
